...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"/login","method":"post","propertyName":"auth_token"},"logout":false,"user":{"url":"/user","method":"get","propertyName":false}},"tokenRequired":true,"tokenType":"","_name":"local"}))
