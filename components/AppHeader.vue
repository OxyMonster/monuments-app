<template>
  <div class="header row p-2">
    ...
    <div class="header__links col-10 row justify-content-end p-0">
      ...
      <div class="header__links__item col-md-2">
        <nuxt-link v-if="!$auth.user" to="/about-us">ჩვენს შესახებ</nuxt-link>
        <nuxt-link v-if="$auth.user" to="/admin">ადმინ პანელი</nuxt-link>
      </div>

      <div class="header__links__item col-md-2 d-flex justify-content-center">
