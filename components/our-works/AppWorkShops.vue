        ...
        getWorkShops() {
            return this.$axios
                ...
                .then((data) => {
                    ...
                    if (this.workShopsList.length > 4) {
                        this.sliderList = [
                        ...
                        if (this.workShopsList.length === 1) {
                            this.sliderList = [this.workShopsList[0]]
                        }
                        if (this.workShopsList.length === 2) {
                            this.sliderList = [
                                this.workShopsList[0],
                                this.workShopsList[1],
                            ]
                        }
                        if (this.workShopsList.length === 3) {
                            this.sliderList = [
                                this.workShopsList[0],
                                this.workShopsList[1],
                                this.workShopsList[2],
